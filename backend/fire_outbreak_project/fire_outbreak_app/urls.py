...
from .views import (
CreateOrListFireService,CreateOrListFireHydrant,CreateOrListFireIncident,
GetOneOrUpdateOneFireService,GetOneOrUpdateOneFireHydrant,GetOneOrUpdateOneFireIncident
